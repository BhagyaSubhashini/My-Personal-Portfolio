      ...
      <div className='p-8 md:p-12'>
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          <div>
            ...
            <p className='text-gray-600 dark:text-gray-300 md:w-2/3'>Get the latest updates on my projects, blog posts, and tech insights delivered staright to your inbox</p>
          </div>
